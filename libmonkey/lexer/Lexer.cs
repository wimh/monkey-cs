...
namespace libmonkey.lexer
{
    public class Lexer
    {
        ...
        public IPeekableEnumerable<Token> Tokens => new TokensEnumerable(_input);

        private class TokensEnumerable : IPeekableEnumerable<Token>
        {
            private readonly string _input;
            ...
            internal TokensEnumerable(string input)
            {
                _input = input;
            }
